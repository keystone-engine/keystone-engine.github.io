...
(This is to introduce the new reversing tool [Keypatch](/keypatch). The tool will be released after our [Blackhat USA 2016 talk](https://www.blackhat.com/us-16/briefings.html#keystone-engine-next-generation-assembler-framework).
